...
import Theme from './__docs__/Theme.md';
import Font from './__docs__/Font.md';
...
import Device from './__docs__/utils/Device.md';
...
import Array from './__docs__/utils/Array.md';
...
export default {
  ...
  routes: [
    ...
    { path: '/get-started', title: '快速上手', component: GetStarted, anchor: GetStarted.$vd.toc },
    { path: '/theme', title: '主题预设', component: Theme, anchor: Theme.$vd.toc },
    { path: '/font', title: '字体预设', component: Font, anchor: Font.$vd.toc },
    {
      path: '/styles',
      title: '样式',
      children: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/device', title: '设备信息', component: Device, anchor: Device.$vd.toc },
        { path: '/date', title: '时间', component: Date, anchor: Date.$vd.toc },
        { path: '/number', title: '数字', component: Number, anchor: Number.$vd.toc },
        { path: '/object', title: '对象', component: Object, anchor: Object.$vd.toc },
        { path: '/array', title: '数组', component: Array, anchor: Array.$vd.toc },
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/logo', title: 'Logo 标识', component: Logo, anchor: Logo.$vd.toc },
